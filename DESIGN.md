...
A concise, readable summary of the rules and the reasoning behind them. The full Game Design Document (with complete change history) is in `CIRCUIT_GDD_v0.4.docx`.
