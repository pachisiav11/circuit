...
- Player 2 can be **Human**, **Random bot** (uniform legal move), **Heuristic AI** (rule-based strategy), or **Claude AI** (model `claude-haiku-4-5` via function-calling — each legal move is a tool).
